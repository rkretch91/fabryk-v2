...
authors: ['ryankretch']
draft: false
summary: Staying fit while traveling doesn't have to be a daunting task! Check out these 5 easy ways to keep up your fitness routine no matter where you are in the world, including classic running, taking local classes, and using nature as your gym. Don't miss out on the delicacies of a country's cuisine while traveling, and make your trip more memorable with these fitness tips.
---
...
Another app that generates random workouts (but is best done with weights), is [Jefit](https://jefit.page.link/eCTJ). I write about it in this [post](https://www.thefabryk.com/blog/best-apps-fitness-healthy-eating/).
...
In another [post](https://www.thefabryk.com/blog/invest-in-online-fitness-coaching/), I preach the benefits of getting an online fitness coach. While this isn't the most affordable option, it took the pain out of having to plan bodyweight workouts when I could not find a gym. While in [Italy for a month](https://www.thefabryk.com/blog/24-hours-napoli-part-1/), I told the coach roughly how much I wanted to work out and he gave me a rotating plans that ultimately gave me better gains than the gym. 

    ...
    <>
      ...
      <SectionContainer>
        {posts.length > MAX_DISPLAY && (
          <button className="theme-button float-right mb-8 h-[48px] w-auto rounded-sm p-2 font-sans text-base font-medium leading-6">
            <Link href="/blog/page/2" aria-label="All posts">
              More, More, More
            </Link>
          </button>
        )}
